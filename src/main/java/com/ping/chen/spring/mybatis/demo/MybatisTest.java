...
import com.ping.chen.spring.mybatis.dao.master.TsTransactionMapper;
...
public class MybatisTest {
    ...
    public static void mybatisTest() throws IOException {
        ...
        try {
            ...
            List<TsTransaction> list = sqlSession.selectList("com.ping.chen.spring.mybatis.dao.master.TsTransactionMapper.listAll", null);
