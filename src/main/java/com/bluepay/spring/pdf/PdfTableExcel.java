...
public class PdfTableExcel {
     ...
     * @throws IOException
     */
    public PdfPTable getTable() throws IOException, BadElementException {
    ...
    protected PdfPTable toParseContent(Sheet sheet) throws IOException, BadElementException {
...
//        table.setLockedWidth(true);
    ...
    protected Phrase getPhrase(Cell cell){
        return new Phrase(getValueFromCell(cell));
    }
